...
{
    public static event Action<int, string?>? StatusChanged;
    ...
    public static void Status(string? message) => Status(0, message);

    public static void Status(int id, string? message) => StatusChanged?.Invoke(id, message);
}