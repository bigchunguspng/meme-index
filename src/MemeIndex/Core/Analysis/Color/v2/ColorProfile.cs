...
public static class ColorProfile
{
    ...
    [
        OFF - OFF,  35 - OFF,  72 - OFF, 110 - OFF,  // Red     Orange  Yellow  Lime
        130 - OFF, 150 - OFF, 200 - OFF, 255 - OFF,  // Green   Cyan    Sky     Blue
        275 - OFF, 320 - OFF, 340 - OFF,       360,  // Violet  Magenta Pink
    ];
